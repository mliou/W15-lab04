package edu.ucsb.cs56.w15.drawings.steventedsen.simple;
...
/**
   ...
   @author Steven Tedsen (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManMiddleCircle = 
       ...
       g2.drawString("Top of snowman added by Steven Tedsen", 20,40);
    }
