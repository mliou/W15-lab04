package edu.ucsb.cs56.w15.drawings.vporter.simple;
...
/**
   ...
   @author Victor Porter (fixed the snowmans's head)
...
{  
   ...
   {  
	...
	g2.draw(snowManTopCircle);       
       ...
       g2.drawString("Top of snowman added by Victor Porter", 20,40);
    }
