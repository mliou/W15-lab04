package edu.ucsb.cs56.w15.drawings.stp.simple;
   ...
   public void paintComponent(Graphics g)
   {
      ...
      Circle snowManMiddleCircle =
       ...
       Circle snowManTopCircle = new Circle(snowManCenterBottomX,
                                            snowManMiddleCircle.getCenterY() - topRadius - snowManMiddleCircle.getHeight()/2,
                                            topRadius);
       ...
       g2.drawString("Top of snowman added by Spencer Prescott", 20,40);
    }
