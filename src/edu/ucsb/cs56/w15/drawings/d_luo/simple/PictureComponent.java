package edu.ucsb.cs56.w15.drawings.d_luo.simple;
...
/**
   ...
   @author Dan Luo (fixed the snowmans's head)
...
{  
   ...
   {  
	...
	Circle snowManHead = 
		...
		(
			snowManCenterBottomX,
			snowManCenterBottomY - bottomRadius * 2 - middleRadius*2 - topRadius, middleRadius
		);
	g2.draw(snowManHead); 
       ...
       g2.drawString("Top of snowman added by Dan Luo", 20,40);
    }
