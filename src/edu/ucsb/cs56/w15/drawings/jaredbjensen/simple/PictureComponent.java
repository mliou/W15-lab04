package edu.ucsb.cs56.w15.drawings.jaredbjensen.simple;
...
/**
   ...
   @author Jared Jensen (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManMiddleCircle = 
       ...
       g2.drawString("Top of snowman added by Jared Jensen", 20,40);
    }
